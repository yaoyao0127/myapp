...
Page({
  ...
  viewNextPage: function () {
    console.log('hah');
    this.setData({
      text: '国，这漫长的没有锅的日子要我怎么度过啊，我现在可是病得不轻！小刀果断地做了决定，明天就去买！第二天我们屁颠屁颠地跑去，那家电器行换了个看店的大叔，完全不会英语，于是我们张牙舞爪，愉快地交流了半天，在各种驴唇不对马嘴地讨论之后，紧张地测试了电饭锅的性能，紧接着，又是一阵用计算器敲打地讨价还价，最终以二十美元的价格成交，双方都是喜笑颜开。拿着新买的电饭锅，我觉得浑身充满了力量，用小刀的话是：“生活又有了盼头。”'
    })
  },
  //监听页面加载
  onLoad: function () {
